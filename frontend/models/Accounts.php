...
class Accounts extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array(' customer_id, balance, number, account_type_id', 'required'),
			array('id, customer_id, number, account_type_id', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			...
			'transactions' => array(self::HAS_MANY, 'Transaction', 'account_from_id'),
			'transactions1' => array(self::HAS_MANY, 'Transaction', 'account_destination_id'),
